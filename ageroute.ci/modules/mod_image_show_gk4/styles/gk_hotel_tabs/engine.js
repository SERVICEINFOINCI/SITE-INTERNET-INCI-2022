...
(function ($) {
  ...
  $(document).ready(function () {
    $(".gkIsWrapper-gk_hotel_tabs").each(function (i, wrapper) {
      return new (_temporalAssertDefined(
        GKHotelTabs,
        "GKHotelTabs",
        _temporalUndefined
      ) && GKHotelTabs)($(wrapper));
  ...
  GKHotelTabs = (function () {
    ...
    _createClass(
      _temporalAssertDefined(GKHotelTabs, "GKHotelTabs", _temporalUndefined) &&
        GKHotelTabs,
      [
        {
          key: "initUI",
        ...
        },
        {
          ...
          value: function waitForImages(time) {
            ...
            $(this.imagesToLoad).each(function (i, el) {
              if (el[0].complete)
                _temporalAssertDefined(process, "process", _temporalUndefined),
                  process++;
            });

            if (
              (_temporalAssertDefined(process, "process", _temporalUndefined) &&
                process) == this.imagesToLoad.length
            ) {
              clearInterval(time);
              this.prepareImages();
            }
            ...
            if (this.mode === "testimonial") {
              ...
              this.wrapper.find("figure").each(function (i, figure) {
                ...
                (
                  ...
                  class: "gkIsSlide",
                  style: (
                    _temporalAssertDefined(img, "img", _temporalUndefined) &&
                    img
                  ).attr("style"),
                  title: (
                    _temporalAssertDefined(img, "img", _temporalUndefined) &&
                ...
                (
                  ...
                  _temporalAssertDefined(img, "img", _temporalUndefined) && img
                );
              ...
              setTimeout(function () {
                ...
                setTimeout(function () {
                  //Insert slider cover
                  $(".gkIsWrapper-gk_hotel_tabs .gkIsSlide").each(function () {
                    this.innerHTML = '<div class="slider-pattern"></div>';
                  });
        ...
        },
        {
          ...
          value: function enableSlideLinks() {
            ...
            (
              _temporalAssertDefined(slides, "slides", _temporalUndefined) &&
              slides
            ).click(function (e) {
        ...
        },
        {
          ...
          value: function prev() {
            ...
            this.animate(
              this.getNext("prev"),
              _temporalAssertDefined(blank, "blank", _temporalUndefined) &&
                blank
            );
          },
        },
        ...
        },
        {
          ...
          value: function animate(nextNum, setBlank) {
            ...
            prevfig = (
              _temporalAssertDefined(prev, "prev", _temporalUndefined) && prev
            ).find("figcaption");
            if (
              _temporalAssertDefined(prevfig, "prevfig", _temporalUndefined) &&
              prevfig
            ) {
              (
                _temporalAssertDefined(
            ...
            (
              _temporalAssertDefined(next, "next", _temporalUndefined) && next
            ).attr("class", "animated");

            (_temporalAssertDefined(prev, "prev", _temporalUndefined) && prev)
              .delay(this.config.animSpeed / 2)
              .animate({ opacity: 0 }, this.config.animSpeed, function () {
                return (
                  _temporalAssertDefined(prev, "prev", _temporalUndefined) &&
                  prev
                ).attr("class", "");
              });
            ...
            (
              _temporalAssertDefined(next, "next", _temporalUndefined) && next
            ).animate({ opacity: 1 }, this.config.animSpeed, function () {
        ...
        },
        {
          ...
          value: function getNext(dir) {
            ...
            if (dir === "next") {
              _temporalAssertDefined(
                _temporalAssertDefined(next, "next", _temporalUndefined) &&
                  next,
                "next",
                _temporalUndefined
              );
        ...
        },
        {
          ...
          value: function oneLoop() {
            ...
            return (
              (_temporalAssertDefined(noLoop, "noLoop", _temporalUndefined) &&
                noLoop) == "true" &&
